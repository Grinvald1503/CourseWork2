...
public class TaskService {
     ...
     public Map<Integer, Tasks> getTasksMap() {
          return tasksMap;
     }

     public static ArrayList<Tasks> getRemovedTasks() {
          return removedTasks;
     }

     public static void setRemovedTasks(ArrayList<Tasks> removedTasks) {
          TaskService.removedTasks = removedTasks;
     }
